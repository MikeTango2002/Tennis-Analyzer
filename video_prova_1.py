...
def main():
    # Read Video
    input_video_path = "input_videos/video_test_1.mp4"
    ...
    player_detections = player_tracker.detect_multiple_frames(video_frames,
                                                              ...
                                                              stub_path='tracker_stubs/player_detections_video_test_1.pkl'
                                                              )
    ...
    ball_detections = ball_tracker.detect_multiple_frames(video_frames,
                                                              read_from_stub=True, 
                                                              stub_path='tracker_stubs/ball_detections_video_test_1.pkl'
                                                              )
    ...
    court_keypoints = court_line_detector.predict_multiple_frames(video_frames,
                                                                    ...
                                                                    stub_path='tracker_stubs/court_keypoints_video_test_1.pkl',
    ...
    save_video(output_video_frames, "output_videos/output_video_test_1.mp4", 24)
